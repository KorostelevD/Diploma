    ...
    <section className="goals-impact">
      <div className="goals-impact__container">
        ...
        <div className="goals-impact__mission">
          <p>
            Наша місія — готувати «на межі»<br/>У "The Lab" ми черпаємо натхнення з
            культового серіалу Breaking Bad, де кожна дія — продумана, кожен
            інгредієнт — точний, і кожна страва — справжній вибух смаку.<br/><br/>Наша
        ...
        <div className="goals-impact__content">
          ...
          <div className="goals-impact__impact">
            ...
            <ul>
              <li>Дизайн і кухня в стилі серіалу.</li>
              <li>
            ...
            <p>Ми не просто ресторан. Ми — історія, яку ти смакуєш.</p>
          </div>
        </div>
      </div>
    </section>
